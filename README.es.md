...
Center, un panel web en Go y React para administrar instancias de
Node-RED. Base de código separada, sin código compartido, diseñada
para convivir con este servidor.